<template>
    <v-container grid-list-xl>
        <h2 data-aos="fade-right" data-aos-duration="600" class="std__title text__black">
            <span data-aos="slide-up" data-aos-delay="800" data-aos-duration="1000" class="subtitle">contacts</span>
            Contact Us
        </h2>
        ...
        <v-layout row wrap>
            <v-flex xs12 sm6 md6 data-aos="fade-right" data-aos-delay="800" data-aos-duration="1000">
                <transition name="fade" mode="out-in">
                    <ul class="location_content" v-for="(item,i) in  locationData" :key="i" v-if="myActive == item.active">
